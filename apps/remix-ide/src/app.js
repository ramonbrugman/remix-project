...
Please make a backup of your contracts and start using http://remix.ethereum.org`)
  ...
  if (window.location.hostname.includes('.ethereum.org') && !registry.get('config').api.exists('settings/matomo-analytics')) {
    modalDialog(
      ...
      yo`
      <div>
        <p>An Opt-in version of <a href="https://matomo.org" target="_blank">Matomo</a>, an open source data analytics platform is being used to improve the Remix IDE website.</p>
